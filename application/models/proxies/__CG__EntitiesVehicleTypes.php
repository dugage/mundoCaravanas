 ...
 */
class VehicleTypes extends \Entities\VehicleTypes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\VehicleTypes' . "\0" . 'id', '' . "\0" . 'Entities\\VehicleTypes' . "\0" . 'name', '' . "\0" . 'Entities\\VehicleTypes' . "\0" . 'dischargeDate', '' . "\0" . 'Entities\\VehicleTypes' . "\0" . 'dischargeDateCode', '' . "\0" . 'Entities\\VehicleTypes' . "\0" . 'upDate', '' . "\0" . 'Entities\\VehicleTypes' . "\0" . 'state'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VehicleTypes $proxy) {
